...
class TEarlyAccessImageGallery extends StatelessWidget {
  const TEarlyAccessImageGallery({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        MyText(text: "GAMBAR TEASER", fontSize: 22, fontFamily: MyFonts.libreBaskerville),
        SizedBox(height: 8),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyText(text: "Add Image", fontSize: 9, textAlign: .center),
                      ],
                    ),
                  ),
                ),
