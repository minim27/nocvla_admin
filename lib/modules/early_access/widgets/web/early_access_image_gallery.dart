...
class EarlyAccessImageGallery extends StatelessWidget {
  const EarlyAccessImageGallery({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        MyText(text: "GAMBAR TEASER", fontSize: 24, fontFamily: MyFonts.libreBaskerville),
        SizedBox(height: 8),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        MyText(text: "Add Image", fontSize: 10, textAlign: .center),
                      ],
                    ),
                  ),
                ),
